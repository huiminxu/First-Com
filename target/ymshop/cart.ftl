...
<!-- 										<a name="stockErrorTips" href="#" data-toggle="tooltip" data-placement="right" title=""></a> -->
						...
						<div style="border: 0px solid;float: right;margin-right: 20px;">
							...
							<div class="row">
								<a href="${basepath}/auth/order/confirmOrder.html" data-toggle="show" data-placement="top" class="btn btn-success" id="confirmOrderBtn" onclick="return confirmOrder()" disabled="disabled">
