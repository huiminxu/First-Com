<%@page import="net.yozo.core.front.SystemManager"%>
<%@page import="net.yozo.services.front.product.bean.Product"%>
<%@page import="net.yozo.services.front.product.ProductService"%>
<%@page
...
<%@page import="net.yozo.services.front.news.bean.News"%>
<%@page import="net.yozo.core.FrontContainer"%>
