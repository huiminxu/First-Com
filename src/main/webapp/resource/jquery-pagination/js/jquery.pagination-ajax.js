 ...
 (function($){
	...
	$.fn.pagination = function(maxentries, opts){
		...
		opts = $.extend({
            ...
            show_if_single_page:false,//只有1页是否显示
    ...
    $(".page-btn").one("click",function(){
      ...
      $(".page-go input").val("");
		...
		function paginationClickHandler(evt){
			...
			console.log("paginationClickHandler"+new_current_page);
