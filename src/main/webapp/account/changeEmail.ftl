...
<@html.htmlBase>
	...
	<div class="container" style="margin-top:20px;min-height: 600px;">
		<div class="row">
			<div class="col-xs-3">
					...
					<div class="col-xs-12" style="font-size: 14px;font-weight: normal;">
						<div class="panel panel-default">
				              <div class="panel-body" style="font-weight: normal;text-align: center;">
				              		<form role="form" id="form" class="form-horizontal" action="${basepath}/auth/account/doChangeEmail.html" theme="simple">
