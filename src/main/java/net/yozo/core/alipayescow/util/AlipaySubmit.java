package net.yozo.core.alipayescow.util;


import net.yozo.core.alipayescow.config.AlipayConfig;
import net.yozo.core.alipayescow.sign.MD5;
import net.yozo.core.alipayescow.util.httpClient.HttpProtocolHandler;
import net.yozo.core.alipayescow.util.httpClient.HttpRequest;
import net.yozo.core.alipayescow.util.httpClient.HttpResponse;
import net.yozo.core.alipayescow.util.httpClient.HttpResultType;
