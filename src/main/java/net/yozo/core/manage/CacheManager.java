package net.yozo.core.manage;//package net.yozo.core.manage;
//
//import java.io.File;
...
//import net.yozo.core.pay.alipay.alipayescow.config.AlipayConfig;
//import net.yozo.core.util.CreateAreaUtil;
...
//import net.yozo.services.front.comment.impl.CommentServiceImpl;
...
//import net.yozo.services.front.product.ProductService;
//import net.yozo.services.front.product.bean.Product;
