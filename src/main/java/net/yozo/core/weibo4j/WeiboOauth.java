...
import net.yozo.core.weibo4j.http.BASE64Encoder;
...
public class WeiboOauth extends Weibo {
	/**
	 * 
	 */
	...
	public WeiboAccessToken getAccessTokenByCode(String code) throws WeiboException {
		return new WeiboAccessToken(client.post(
