...
public class Trend extends Weibo {
	 ...
	 * @see//open.weibo.com/wiki/2/trends
	 * @since JDK 1.5
	 */
	 ...
	 * @see//open.weibo.com/wiki/2/trends/is_follow
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @throws JSONException
	 * @see//open.weibo.com/wiki/2/trends/hourly
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @throws JSONException
	 * @see//open.weibo.com/wiki/2/trends/daily
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @throws JSONException
	 * @see//open.weibo.com/wiki/2/trends/weekly
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @throws JSONException
	 * @see//open.weibo.com/wiki/2/trends/follow
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @throws JSONException
	 * @see//open.weibo.com/wiki/2/trends/destroy
	 * @since JDK 1.5
	 */
