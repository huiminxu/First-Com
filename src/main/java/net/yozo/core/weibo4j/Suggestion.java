...
public class Suggestion extends Weibo {
	 ...
	 * @see//open.weibo.com/wiki/2/suggestions/users/hot
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/suggestions/users/may_interested
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/suggestions/users/by_status
	 * @since JDK 1.5
	 */
	 ...
	 * @see//open.weibo.com/wiki/2/suggestions/statuses/reorder
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/suggestions/statuses/reorder/ids
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/suggestions/favorites/hot
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/suggestions/users/not_interested
	 * @since JDK 1.5
	 */
