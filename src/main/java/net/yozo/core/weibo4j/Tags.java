...
public class Tags extends Weibo {
	 ...
	 * @see//open.weibo.com/wiki/2/tags
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/tags/tags_batch
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/tags/suggestions
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/tags/create
	 * @since JDK 1.5
	 */
	 ...
	 * @see//open.weibo.com/wiki/2/tags/destroy
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/tags/destroy_batch
	 * @since JDK 1.5
	 */
