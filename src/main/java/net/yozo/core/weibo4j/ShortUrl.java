...
public class ShortUrl extends Weibo {
	 ...
	 * @see//open.weibo.com/wiki/2/short_url/shorten
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/expand
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/clicks
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/referers
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/locations
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/share/counts
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/share/statuses
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/comment/counts
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/short_url/comment/comments
	 * @since JDK 1.5
	 */
