...
public class PublicService extends Weibo {
	 ...
	 * @see//open.weibo.com/wiki/2/common/code_to_location
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/common/get_province
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/common/get_city
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/common/get_country
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/common/get_timezone
	 * @since JDK 1.5
	 */
