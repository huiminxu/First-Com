...
public class Account extends Weibo {
	 ...
	 * @see//open.weibo.com/wiki/2/account/get_uid
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/account/get_privacy
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/account/profile/school_list
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/account/rate_limit_status
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.2
	 * @see//open.weibo.com/wiki/2/account/end_session
	 * @since JDK 1.5
	 */
