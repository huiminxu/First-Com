...
import net.yozo.core.weibo4j.model.User;
import net.yozo.core.weibo4j.model.UserCounts;
...
public class Users extends Weibo {
	 ...
	 * @see//open.weibo.com/wiki/2/users/show
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see//open.weibo.com/wiki/2/users/domain_show
	 * @since JDK 1.5
	 */
