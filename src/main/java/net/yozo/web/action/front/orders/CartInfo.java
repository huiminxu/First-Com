...
public class CartInfo extends PagerModel implements Serializable {
	...
	private List<Template> templateList;// 购物车中商品列表
//	private String productTotal;//商品总金额
	...
	public void totalCacl(){
		...
		for(int i=0;i<getTemplateList().size();i++){
			Template p = getTemplateList().get(i);
			_amount += Double.valueOf(p.getNowPrice());
		}
	...
	public String toString() {
		return "CartInfo [templateList=" + templateList + ", amount=" + amount
